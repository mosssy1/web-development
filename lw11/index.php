...
<body style="margin: 0px; width:auto; overflow-x:hidden;"> 
  <header class="header">
    ...
    <a href="#" class="header_enroll_open_pop_up">
        Записаться на курс
    </a> 
  </header>
  <main>
    ...
    <div class="popup__bg"> 
        <div class="popup">
            <div class="welcome">
                <div class="close_pop_up_button">
                    <a href="#" class="close_button">
                        <img src="./img/Closepopup.png">
                    </a>
                </div>
                <div class="form_ill">
                    <img src="img/Welcome.png" id="image">
                </div>   
                <div class="enroll_on_course_form" id="title">
                    <p>Записаться на курс</p>
                </div>
                <form class="form" action="src/form_handler.php" method="POST" id="form">
                    <input class="form__name _req" name="name" type="text" placeholder="Ваше имя" ></input>
                    <input class="form__email _req" name="email" type="email" placeholder="Email"></input>
                    <select class="form__work" placeholder="Деятельность" name="activity">
                    ...
                    <div class="permission">
                        <label class="permission__check_label">
                            <input class="permission__check_input" type="checkbox" name="agreed">Согласен получать информационные материалы о старте курса
                        </label>
                    </div>   
                    <div class="enroll_button">
                        <button class="enroll_form" type="submit">
                            <p>Записаться на курс</p>
                        </button>
                    </div>    
                </form>
